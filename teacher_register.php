<?php
 ...
 if (isset($_POST['submit'])) {
    ...
    $password = md5($pass_txt);
   	$sql = mysqli_query($con,"INSERT INTO teachers (name,school,username,subject,email,password) VALUES ('{$name}','{$school}','{$usr}','{$sub}','{$mail}','{$password}')");
   	if ($sql) {
    ...
    <div class="container-fluid">
    	<div class="row">
    		...
    		<div class="d-none d-md-block col-md-6 col-lg-6 col-xl-6">
    			...
    			<h2 class="body_txt">Thankyou for joining with us.</h2>
    		</div>
    		</div>
    		</div>
            ...
            <input type="text" name="sub" placeholder="Subject" class="col-12 input_b" required><br>
