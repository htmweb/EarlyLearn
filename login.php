<?php
 ...
 if (isset($_POST['submitin'])) {
    ...
    $md5pss= md5($pass_txt);
   	$q = mysqli_query($con,"SELECT*FROM students WHERE email='{$mail}' and password='{$md5pss}' LIMIT 1");
    ...
    <div class="container-fluid">
    	<div class="row">
    		...
    		<div class="d-none d-md-block col-md-6 col-lg-6 col-xl-6">
    			...
    			<h2 class="body_txt">Hi! Welcome Again.<br><br>Continue Your Learning now...<br></h2>
